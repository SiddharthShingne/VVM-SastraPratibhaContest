...
function useApi() {
    ...
    const request = async (endpoint, method = "GET", body)=>{
        ...
        try {
            ...
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${endpoint}`, {
                method,
                headers: {
...
function LoginPage() {
    ...
    const { request, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApi"])();
    ...
    const handleLogin = async (e)=>{
        ...
        setLocalError("");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])(request, username, password);
...
_s(LoginPage, "eAqoOnY8a1Qq3lmD3MoaqqJliMY=", false, function() {
    return [
...
//# sourceMappingURL=src_384d3c92._.js.map