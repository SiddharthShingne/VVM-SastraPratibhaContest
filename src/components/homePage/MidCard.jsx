    ...
    <div>
      ...
      <section className="relative overflow-hidden py-16 bg-linear-to-br from-[#eef3f8] via-[#e4ebf3] to-[#f8fafc]">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <Link
              href="/Register"
              className="flex items-center gap-3 px-5 py-3 rounded-full bg-linear-to-r from-yellow-400 to-yellow-300 text-[#17395c] font-bold shadow-lg hover:scale-105 transition"
            >
            ...
            <a
              ...
              className="flex items-center gap-3 px-5 py-3 rounded-full bg-linear-to-r from-[#102c48] to-[#1e4a74] text-white font-bold shadow-lg hover:scale-105 transition"
            >
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-6 text-center md:text-left">
              ...
              <p className="text-gray-600 max-w-xl">
                A digital-based and one of the largest science talent search
                examination
              </p>
              ...
              <div className="bg-white/80 backdrop-blur-lg p-6 rounded-3xl shadow-xl max-w-md w-full">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <h4 className="text-lg font-bold mt-2 text-[#17395c]">
                      Srijan Internship VVM 2026-27
                    </h4>
                  ...
                  <div>
                    ...
                    <h4 className="text-lg font-bold mt-2 text-[#17395c]">
                      Largest Digital Science Talent Search
                    </h4>
                    <p className="text-sm text-gray-600">
                      Science exam for Emerging India.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-linear-to-br from-[#eef3f8] via-[#e4ebf3] to-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          {/* LEFT */}
          <div>
            <span className="text-yellow-600 font-bold uppercase text-sm">
              About VVM
            </span>
            ...
            <p className="text-gray-600 mb-6">
              Vidyarthi Vigyan Manthan (VVM) is an initiative of Vijnana Bharati
              (VIBHA), in collaboration with NCERT and NCSM under Government of
              India.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-3 bg-blue-100 p-4 rounded-xl shadow border-2 border-[#17395c]"
                >
