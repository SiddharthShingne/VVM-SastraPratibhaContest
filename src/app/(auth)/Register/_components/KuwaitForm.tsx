...
export default function KuwaitForm({ countries }: Props) {
    ...
    useEffect(() => {
        const loadSchools = async () => {
            try {
                const res = await getSchools(1, 500, undefined, "KW"); // ← change "QA" per form
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-md md:col-span-2">
                            <div className="h-64 overflow-y-auto bg-gray-100 p-4 rounded-md text-sm text-gray-700 space-y-3">
                                <ol className="list-decimal pl-5">
                                    ...
                                    <li className="py-2">The student is responsible for keeping their login credentials confidential until the exam. The same credentials will be used for the exam, and any activity performed using the account will be considered the student&rsquo;s responsibility.</li>
                            ...
                            <p className="text-red-500 text-sm mt-2">
                                After completing the online registration, please ensure that the physical registration form provided by the school is duly completed and returned to the school along with the applicable registration fee.Your login credentials will be send by email, once we receive  payment.                            </p>
