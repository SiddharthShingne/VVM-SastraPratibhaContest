...
export default function RegisterPage() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(145deg, #dde8f5 0%, #eef3fa 40%, #f5f0d8 100%)",
      }}
    >
      <div
        className={`w-full mx-auto transition-all duration-500 ${selectedCountry ? "max-w-300" : "max-w-145"}`}
      >
        {!selectedCountry && (
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 40px 80px rgba(23,57,92,0.14), 0 8px 24px rgba(23,57,92,0.08), inset 0 1px 0 rgba(255,255,255,1)",
            }}
          >
            {/* Animated top bar */}
            <div
            ...
            <div
              ...
              style={{
                ...
                top: -80,
                background:
                  "radial-gradient(circle, rgba(244,223,23,0.15) 0%, transparent 70%)",
                zIndex: 0,
            ...
            <div
              ...
              style={{
                ...
                bottom: -60,
                background:
                  "radial-gradient(circle, rgba(23,57,92,0.09) 0%, transparent 70%)",
                zIndex: 0,
            ...
            <div className="relative z-10 p-10">
              ...
              <div className="flex justify-center mb-6">
                <div
                  ...
                  style={{
                    boxShadow: "0 8px 28px rgba(23,57,92,0.25)",
              ...
              <h2
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #17395c 30%, #2a6099 80%)",
              ...
              <div className="flex items-center gap-3 mb-6">
                <div
                  ...
                  style={{ background: "rgba(23,57,92,0.1)" }}
                />
              ...
              <div className="flex justify-center gap-2 mt-8">
                <div
                  ...
                  style={{
                    background: "linear-gradient(90deg,#17395c,#2a6099)",
                  }}
                />
                <div
      ...
      <style jsx global>{`
        ...
        @keyframes orb2 {
          ...
          50% {
            transform: translate(-25px, 18px) scale(0.9);
          }
        }
      `}</style>
    </div>
